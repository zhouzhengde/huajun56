...
package com.huajun56.common.json;

import com.huajun56.common.json.annotation.JsonPathValue;
import com.huajun56.common.util.$;
import com.huajun56.common.util.DateUtils;
...
public final class JsonUtils {
    ...
    private static void injectValue(Object instance, Field field, Object value) {
        ...
        try {
            ...
            LOGGER.error("[JsonUtils Inject Value] [Name]:" + field.getName() + "; [Value]:" + value.toString(), e);
        } finally {
