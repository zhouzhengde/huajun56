define([
    ...
    md.controller('RequirementListCtrl', ['$scope', '$uibModal', 'RequirementResource', '$pager', function ($scope, $uibModal, $requirementResource, $pager) {
        ...
        $scope.reload = function (pager, pageIndex) {
            ...
            $requirementResource.list(pager, function (data) {
                if (data.status == 200) {
